...
4-2 nmcli connection modify [con-name] ifname ipv4.method.manual 
nmcli con reload 
nmcli connection down [con-name]
nmcli con up [con-name]
Route 정보관리 route -n , netstat -nr 
...
ls -l /etc/profile : 로그인시 변경 

vi .bash_profile -> umask 000 
vi .bashrc -> umask 000
umask 하면 umask 상태가 바뀐다. 
userdel -r username -> 계정삭제
usermod -m -d /home/계정 
